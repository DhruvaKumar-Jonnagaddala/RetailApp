  ...
  stages {
    ...
    stage('CodeQualityCheck'){
      steps {
        ...
        sh 'export JAVA_HOME=/vagrant/tools/hudson.model.JDK/jdk8 && export GRADLE_HOME=/vagrant/tools/hudson.plugins.gradle.GradleInstallation/gradlelatest && export PATH=$PATH:$JAVA_HOME/bin:$GRADLE_HOME/bin && export && chmod +x gradlew && ./gradlew sonarqube -Dsonar.organization=dhruvanam-github -Dsonar.host.url=https://sonarcloud.io -Dsonar.login=56697f1b99fc4890f05c6582f916591975820715'
      }
    }
  }
}
